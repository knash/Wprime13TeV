...
DataB11 = ROOT.TFile("rootfiles/TBanalyzerdata_Trigger_none_none_PSET_"+options.cuts+".root")
...
TTmc = ROOT.TFile("rootfiles/TBanalyzerttbar_Trigger_nominal_none_PSET_"+options.cuts+".root")
